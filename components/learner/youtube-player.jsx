...
export function YoutubePlayer({ videoId, onEnded, className = "" }) {
  ...
  return (
    <div className={`overflow-hidden rounded-lg bg-navy ${className}`}>
      ...
      {/* ── Custom Controls ── */}
      {ready && (
        <div className="bg-navy-deep select-none px-3.5 pt-2.5 pb-3 space-y-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={speedMenuRef}>
              ...
              {showSpeed && (
                <div className="absolute bottom-7 right-0 z-20 bg-navy-soft border border-white/10 rounded-xl py-2 w-44 shadow-2xl">
