...
export const adminNav = {
  ...
  courseManagement: [
    { title: "Content Library",     icon: Library,      href: "/admin/courses",     permission: "manage_courses"    },
    { title: "Assessment Builder",  icon: ClipboardList,href: "/admin/assessments", permission: "build_assessments" },
    { title: "Learning Journeys",   icon: Map,          href: "/admin/journeys",    permission: "manage_courses"    },
  ...
  analytics: [
    { title: "Departments",    icon: Building2, href: "/admin/departments",    permission: "view_reports"       },
    { title: "Reports",        icon: BarChart3, href: "/admin/reports",        permission: "view_reports"       },
    { title: "Learning Hours", icon: Timer,     href: "/admin/learning-hours", permission: "view_reports"       },
